---
title: "[Architecture] 읽으면 유용한 아키텍처 관련 칼럼 모음" # post의 layout이 기본적으로 post로 설정되어있어서 Front Matter에 따로 layout변수를 만들어 주지 않아도 됨
date: 2022-04-28 +0800
categories: [Architecture] # categories는 최대 2개까지 가능
tags: [architecture] # TAG는 반드시 소문자로 이루어져야함, 0~무한개까지 지정 가능
