---
title: "[DDDSTART] Chatper1-도메인 모델 시작 정리" # post의 layout이 기본적으로 post로 설정되어있어서 Front Matter에 따로 layout변수를 만들어 주지 않아도 됨
...
![image](https://user-images.githubusercontent.com/44339530/233836677-dd4ed14c-9c8d-4013-9af2-03ba082d6e8f.png)
